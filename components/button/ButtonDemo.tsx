...
const buttonStyles = {
  default: {
    defaultColor: "bg-white hover:bg-neutral-200 text-primary",
    // success: "bg-green-600 hover:bg-green-500",
    green: "bg-success hover:bg-success-hover",
    // warning: "bg-yellow-600 hover:bg-yellow-500",
    yellow: "bg-warning hover:bg-warning-hover",
    blue: "bg-primary text-white hover:bg-[rgb(11,33,67)]"
  },
  secondary: {
    defaultColor: "",
...
type ButtonDemoProps = React.ButtonHTMLAttributes<HTMLButtonElement> & {
  ...
  color?: "defaultColor" | "green" | "yellow" | "blue";
  disabled?: boolean;
  onClick?: () => void;
};
...
export function ButtonDemo({
  ...
  return (
    <Button
      ...
      size={size}
      disabled={disabled}
      className={`${className} ${buttonStyle} font-normal cursor-pointer`}
      onClick={onClick}
      {...props}
    >
      {startIcon}
